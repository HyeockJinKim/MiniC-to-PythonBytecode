public enum OpCode {
    ...
    BINARY_ADD("17"), BINARY_SUBTRACT("18"), BINARY_SUBSCR("19"),
    STORE_SUBSCR("3c"), PRINT_EXPR("46"), PRINT_ITEM("47"), PRINT_NEWLINE("48"),
    BREAK_LOOP("50"), LOAD_LOCALS("52"), RETURN_VALUE("53"), STORE_NAME("5a"),
    STORE_GLOBAL("61"), LOAD_CONST("64"), LOAD_NAME("65"), BUILD_LIST("67"),
